...
def login_school(username, password):
    ...
    with get_db() as conn:
        ...
        if school['is_locked']:
            return None, "Account locked. Contact Developer"
    ...
    session['must_change_password'] = school['must_change_password'] if school['must_change_password'] is not None else 0
    ...
    return {
        ...
        'must_change_password': school['must_change_password'] if school['must_change_password'] is not None else 0
    }, None
...
def login_developer(username, password):
    ...
    with get_db() as conn:
        ...
        if dev['is_locked']:
            print("[DEBUG] Developer account is locked")
            return None, "Developer account is locked"
        
        if not dev['is_active']:
            print("[DEBUG] Developer account is inactive")
            return None, "Developer account is inactive"
