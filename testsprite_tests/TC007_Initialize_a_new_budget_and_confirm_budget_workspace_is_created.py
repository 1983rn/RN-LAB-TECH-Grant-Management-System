...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields and submit the login form to sign in as the school user.
        ...
        # -> Click the 'Budget Allocation' navigation link to open the budget allocation/initialization page.
        frame = context.pages[-1]
        # Click element
