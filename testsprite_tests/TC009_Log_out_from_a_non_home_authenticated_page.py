...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields, then submit the login form by clicking the 'Login to System' button (index 46).
        ...
        # -> Navigate to /budget to simulate being in another authenticated area, then trigger logout (use the logout endpoint) and verify that the app returns to the login page and shows the login form.
