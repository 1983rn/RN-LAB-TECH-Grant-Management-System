...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the password-reset / OTP request page so we can check whether the OTP entry UI is displayed.
        await page.goto("http://127.0.0.1:5176/password-reset")
        
        # --> Assertions to verify final state
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Enter OTP')]").nth(0).is_visible(), "The OTP entry form should be visible after navigating to the password reset page"
