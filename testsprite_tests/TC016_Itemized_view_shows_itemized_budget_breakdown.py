...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Itemized' navigation link to open the itemized view, wait for the page to load, then verify an itemized budget breakdown is displayed.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/aside/div/nav/a[6]').nth(0)
        await asyncio.sleep(3); await elem.click()
